...
task_data = {
    ...
    "category_id": category_id,
    "levels": [
        {"level": 1, "description": "Basic", "target_value": 1, "unit": "minutes"},
        {"level": 2, "description": "Good", "target_value": 5, "unit": "minutes"},
        {"level": 3, "description": "Excellent", "target_value": 20, "unit": "minutes"},
        {"level": 4, "description": "Extraordinary", "target_value": 1, "unit": "hours"}
    ]
}
response = requests.post(f"{BASE_URL}/task", json=task_data)
print("Creating task:")
